...
RAG pipelines · RL environments · real-time apps
open to summer internship in SWE or AI/ML
```
...
transformer classifier on satellite imagery for blue carbon credit estimation, deployed on AWS  
